package dev.vdrenkov.handler;

import dev.vdrenkov.exception.AuthorNotFoundException;
import dev.vdrenkov.exception.BookNotFoundException;
import dev.vdrenkov.exception.ClientNotFoundException;
import dev.vdrenkov.exception.OrderNotFoundException;
import dev.vdrenkov.exception.UserNotFoundException;
import dev.vdrenkov.exception.UserRoleNotFoundException;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<String> handleDataIntegrityViolationException(DataIntegrityViolationException exception) {
    log.error(CAUGHT_EXCEPTION, exception);
    String message = "You are violating database rule/s";
    return new ResponseEntity<>(message, HttpStatus.BAD_REQUEST);
  }
